...
Patch1000: pam-1.1.8-faillock-systemtime.patch
Patch1001: pam-1.1.8-faillock-failmessages.patch
Patch1002: pam-1.1.8-mod-chinese-date-format.patch

%if 0%{?uvp_custom_build}
Patch1003: 1003-uvp-bugfix-pam-1.1.8-root-check.patch
%endif

Patch1100: pam-1.1.8-translation-missing-add.patch
...
%patch1000  -p1 -b .systemtime
%patch1001  -p1 -b .failmessages
%patch1002  -p1
