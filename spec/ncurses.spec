...
Patch1000: ncurses_CVE-2017-16879.patch
Patch1001: ncurses-5.9-CVE-2017-10684_10685.patch
...
The curses library routines embedded
...
%post libs-embedded -p /sbin/ldconfig

%postun libs-embedded -p /sbin/ldconfig
