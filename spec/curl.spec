%if 0%{?uvp_custom_build}
    %global _prefix /usr/lib/curl-openssl
    %define RPM_NAME curl-openssl
    %define LIBCURL_NAME libcurl-openssl
%else
    %define RPM_NAME curl
...
Patch1000: curl-CVE-2016-7167.patch
Patch1001: curl-CVE-2016-8615.patch
Patch1002: curl-CVE-2016-8616.patch
Patch1003: curl-CVE-2016-8617.patch
Patch1004: curl-CVE-2016-8618.patch
Patch1005: curl-CVE-2016-8619.patch
Patch1006: curl-CVE-2016-8621.patch
Patch1007: curl-CVE-2016-8622.patch
Patch1008: curl-CVE-2016-8623.patch
Patch1009: curl-CVE-2016-8624.patch

Patch1010: curl-CVE-2016-8616-modify.patch
# Fix for CVE-2017-1000254
Patch5000: curl_7.29.0_CVE-2017-1000254.patch
Patch5001: curl-CVE-2017-1000257.patch
Patch5002:       curl_7.29.0_CVE-2017-8817.patch
Patch5003: curl_7.29.0_CVE-2018-1000120.patch
Patch5004: curl_7.29.0_CVE-2018-1000121.patch
Patch5005: curl_7.29.0_CVE-2018-1000122.patch
Patch5006: curl-CVE-2018-1000301.patch
Patch5007: curl-CVE-2016-9586.patch

Patch6000: 0001-curl-NO_PROXY-fix-for-IPv6-numericals-in-the-URL.patch
...
Requires: %{LIBCURL_NAME} = %{version}-%{release}
...
%package -n %{LIBCURL_NAME}-devel
Summary: Files needed for building applications with %{LIBCURL_NAME}
Group: Development/Libraries
Requires: %{LIBCURL_NAME} = %{version}-%{release}
...
%description -n %{LIBCURL_NAME}-devel
The %{LIBCURL_NAME}-devel package includes header files and libraries necessary for
developing programs which use the %{LIBCURL_NAME} library. It contains the API
...
%post -n %{LIBCURL_NAME} -p /sbin/ldconfig

%postun -n %{LIBCURL_NAME} -p /sbin/ldconfig
...
%files -n %{LIBCURL_NAME}
%defattr(-,root,root,-)
%{_libdir}/libcurl.so.*

%files -n %{LIBCURL_NAME}-devel
%defattr(-,root,root,-)
