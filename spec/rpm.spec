...
Name: rpm
Version: %{rpmver}
Release: %{?snapver:0.%{snapver}.}25%{?dist}.h4
...
%patch9001 -p1 -b .get-file-signing-key-password
%patch9002 -p1 -b .add-aarch64_ilp32-arch
%patch9003 -p1 -b .enable-disable-sepdebugcrcfix-buildi
%patch9004 -p1 -b .fix-build-with-recent-binutil
