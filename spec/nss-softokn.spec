...
Patch1000:	nss_tuning_for_aarch64.patch
Patch1001:	nss-softokn-bltest_verify_dsa.patch
Patch1002:  nss-softokn-3.16-add-new-NSS_SDB_USE_CACHE-value-force.patch
%description
...
%patch1000 -p1 -b .nsstuning4aarch64
%patch1001 -p1 -b .nss_bltest_rsa
%patch1002 -p1
%build
