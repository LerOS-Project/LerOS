...
Requires: pam-embedded >= 1.1.3-7, /etc/pam.d/system-auth
Requires: audit-libs-embedded >= 1.0.6
...
Patch1001: 1001-ensure-sched_getscheduler-sched_getparam-can-be-called.patch
Patch1002: add_no_tell_kernel_opt.patch
