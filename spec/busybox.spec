...
#Provides: /bin/tar
#Provides: /bin/xz
#Provides: /sbin/addgroup
#Requires: setup
%package embedded 
Group: System Environment/Shells
Summary: Embedded verison of busybox
Provides: bundled(md5-drepper2)
Provides: /bin/sha512sum
Provides: /bin/awk
Provides: /bin/tar
...
%files
%doc LICENSE README
#%attr(4755, root, root) /sbin/busybox
...
* Thu Mar 05 2015 Dan HorÃ¡k <dan[at]danny.cz> - 1:1.22.1-2
...
* Fri May 24 2013 Dan HorÃ¡k <dan[at]danny.cz> - 1.19.4-10
