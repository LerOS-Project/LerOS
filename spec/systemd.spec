...
Patch1505: 1505-log-minor-fixes.patch
Patch1506: 1506-set-sd-bus-status-to-BUS_CLOSING-when-bus_socket_pro_new.patch

Patch1601: journald-fix-allocate-failed-journal-file.patch
Patch1602: 1602-activation-service-must-be-restarted-when-reactivated.patch
Patch1603: 1603-udev-add-actions-while-rename-netif-failed.patch
#Patch1604: 1604-fix-automount-block-and-mounted-status-when-mounting-timeout.patch
Patch1509: 1509-fix-journal-file-descriptors-leak-problems.patch
Patch1605: 1605-update-rtc-with-system-clock-when-shutdown.patch
Patch1609: 1609-Make-systemd-udevd.service-start-after-systemd-remou.patch

Patch2002: 2002-resolved-use-for-comparing-unsigned-against-zero.patch
Patch2003: 2003-build-make-sure-to-test-for-Wflag-instead-of-Wno-fla.patch
Patch2004: 2004-sd-rtnl-types-fix-check-for-unsupported-type.patch
Patch2005: 2005-v4l_id-use-standard-option-parsing-loop.patch
Patch2006: 2006-bus-util-remove-stray-errno-assignment.patch
Patch2007: 2007-core-dbus-manager-remove-dead-check.patch
Patch2009: 2009-socket-util-refactor-error-handling-in-sockaddr_pret.patch
Patch2010: 2010-bus-remarshal-kdbus-messages-received-from-the-kerne.patch
Patch2011: 2011-core-fix-cgroups-agent-match-for-kdbus.patch
Patch2012: 2012-nspawn-tell-coverity-that-we-ignore-return-value.patch
Patch2013: 2013-core-don-t-wait-for-reply-if-writing-to-pipe-fails.patch
Patch2014: 2014-core-explicitly-ignore-failure-during-cleanup.patch
Patch2015: 2015-bus-explicitly-ignore-failure-during-error-handling.patch
Patch2016: 2016-set-forwardtowall-no-to-avoid-emerg-log-shown-on-she.patch
Patch2017: 2016-logind-explicitly-ignore-errors-we-can-do-nothing-ab.patch
Patch2018: 2017-core-one-more-void.patch
Patch2019: 2018-core-check-asprintf-return-value.patch
Patch2020: 2019-sd-dhcp-client-fix-strict-aliasing-issue.patch
Patch2021: 2020-udev-ctrl-fix-strict-aliasing-issues.patch
Patch2022: 2021-libudev-monitor-use-initialization.patch
Patch2023: 2022-util-check-asprintf-return-value.patch
Patch2024: 2023-logind-check-return-value-of-session_release.patch
Patch2025: 2024-udev-virsh-shutdown-vm.patch
Patch2026: 2024-Add-void-where-we-don-t-care-about-return-value.patch
Patch2027: 2025-vconsole-setup-check-error-of-child-process.patch
Patch2028: 2026-core-Remove-explicit-Plymouth-integration.patch
Patch2029: 2027-shared-reinstate-plymouth_running.patch
Patch2030: 2028-strv-return-NULL-from-strv_free.patch
Patch2031: 2029-networkd-use-LOG_WARN-not-LOG_ERR-for-non-fatal-erro.patch
Patch2032: 2030-sd-rtnl-handle-empty-multi-part-message-from-the-ker.patch
Patch2033: 2031-bootchart-more-useful-error-message-for-common-error.patch
Patch2034: 2032-timedatectl-fix-when-queried-system-has-differn-t-ti.patch
Patch2035: 2033-man-Second-example-systemd-socket-proxyd-does-not-ne.patch
Patch2036: 2034-sd-rtnl-Always-enable-IFA_FLAGS.patch
Patch2037: 2035-networkd-dhcp6-Do-not-handle-prefix-expiry.patch
Patch2038: 2036-cdrom_id-unroll-and-simplify-data-check-loop.patch
Patch2039: 2037-network-don-t-pass-NULL-to-udev_device_get_driver.patch
Patch2041: 2038-systemd-bootchart-Prevent-closing-random-file-descri.patch
Patch2042: 2039-systemd-bootchart-Prevent-leaking-file-descriptors-i.patch

Patch2999: 2040-systemd-bootchart-Repair-Entropy-Graph.patch
Patch3000: 2041-man-document-default-timeouts-and-start-limit-parame.patch
Patch3001: 2042-man-document-in-timedatectl-1-that-the-NTP-state-sho.patch
Patch3002: 2043-man-update-timedatectl-1-s-examples.patch
Patch3003: 2044-missing.h-define-IFA_FLAGS-if-it-is-missing.patch
Patch3004: 2045-sd-rtnl-properly-size-attribute-array-if-IFA_FLAGS-w.patch
Patch3005: 2046-vconsole-stick-to-kernel-style-function-error-handli.patch
Patch3006: 2047-test-journal-flush-fix-memleak.patch

Patch3048: 2048-terminal-idev-fix-NULL-terminator-for-bus-property-m.patch
Patch3050: 2050-sysv-generator-fix-mem-leaks.patch
Patch3051: 2051-sysv-generator-free-LookupPaths-also-on-error.patch
Patch3052: 2052-efi-boot-generator-Continue-if-boot-does-not-exist.patch
Patch3053: 2053-efi-boot-generator-need-need-to-proceed-if-boot-is-a.patch
Patch3054: 2054-selinux-use-different-log-priorites-for-log-messages.patch
Patch3055: 2055-networkd-fix-confusion-between-log_netdev_error-but-.patch
Patch3056: 2056-core-rework-crash-handling.patch

Patch3057: 1606-cgroup-slice-advanced.patch
Patch3058: 1612-serialize-pids-for-scope-when-not-started.patch
Patch3061: 1615-do-not-finish-job-during-daemon-reload-in-unit_notify.patch
Patch3062: 1616-udevd-enhance-check-for-hang-tasks.patch
Patch3063: 1617-bus-cookie-must-wrap-around-to-1.patch
Patch3064: 1619-delay-to-restart-when-a-service-can-not-be-auto-restarted.patch
Patch3065: 1620-nop_job-of-a-unit-must-also-be-coldpluged-after-deserization.patch
Patch3066: 1507-Failed-at-step-CGROUP-spawning.patch
Patch3067: 1516-systemd-add-log-info-when-modules-load-failed.patch
Patch3068: 1517-systemd-support-setting-memory.memsw.limit_in_bytes.patch
Patch3069: 1605-systemd-core-fix-problem-of-dbus-service-can-not-be-started.patch
Patch3070: 1607-systemd-core-kill-spawned-process-at-starting-service.patch
Patch3072: 1610-add-new-rules-for-lower-priority-events-to-preempt.patch
Patch3073: 1611-systemd-core-fix-problem-on-forking-service.patch
Patch3074: 1515-systemd-core-Fix-memory-leak-in-cgroup_context_apply.patch

Patch3075: 0001-automount-rework-propagation-between-automount-and-m.patch
Patch3076: 0001-core-remember-first-unit-failure-not-last-unit-failu.patch
...
%package embedded
Summary:        part embedded of systemd
License:        LGPLv2+ and MIT
Provides:       /bin/systemctl
Provides:       systemd-units = %{version}-%{release}
Requires:	util-linux-embedded
Requires:	busybox-embedded
...
systemd-tmpfiles --create >/dev/null 2>&1 || :
%post embedded
systemd-machine-id-%post >/dev/null 2>&1 || :
journalctl --update-catalog >/dev/null 2>&1 || :
chgrp systemd-journal /run/log/journal/ /run/log/journal/`cat /etc/machine-id 2> /dev/null` /var/log/journal/ /var/log/journal/`cat /etc/machine-id 2> /dev/null` >/dev/null 2>&1 || :
chmod g+s /run/log/journal/ /run/log/journal/`cat /etc/machine-id 2> /dev/null` /var/log/journal/ /var/log/journal/`cat /etc/machine-id 2> /dev/null` >/dev/null 2>&1 || :
systemctl enable serial-getty@ttyS0.service
systemctl enable serial-getty@ttyAMA0.service
sed -i "s/BindsTo=dev/#BindsTo=dev/g" /usr/lib/systemd/system/serial-getty@.service
sed -i "s/After=dev/#After=dev/g" /usr/lib/systemd/system/serial-getty@.service
ln -sf /usr/lib/systemd/system/multi-user.target /etc/systemd/system/default.target
echo LerOS > /etc/hostname
...
%exclude %{_prefix}/lib/systemd/system/multi-user.target
...
%exclude %{_prefix}/lib/systemd/system/basic.target
%exclude %{_prefix}/lib/systemd/system/basic.target.wants
%exclude %{_prefix}/lib/systemd/system/sysinit.target
#%dir %{_prefix}/lib/systemd/system/sysinit.target.wants
%exclude %{_prefix}/lib/systemd/system/sysinit.target.wants/systemd-journald.service
%exclude %{_prefix}/lib/systemd/system/swap.target
%exclude %{_prefix}/lib/systemd/system/sockets.target
#%dir %{_prefix}/lib/systemd/system/sockets.target.wants
%exclude %{_prefix}/lib/systemd/system/sockets.target.wants/systemd-journald.socket
%exclude %{_prefix}/lib/systemd/system/tmp.mount
%exclude %{_prefix}/lib/systemd/system/umount.target
%exclude %{_prefix}/lib/systemd/system/shutdown.target
...
%dir %{_prefix}/lib/systemd/system/rescue.target.wants
